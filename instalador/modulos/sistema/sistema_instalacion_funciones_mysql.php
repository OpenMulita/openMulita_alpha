...
/*
 <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
 fun_sistema_modulos_cambioEstado
 fun_mulita_usuarios_validarDesarrollador
 fun_mulita_modulos_cambioEstado
 fun_mulita_gestiones_cambioEstado
 fun_mulita_acciones_cambioEstado
 fun_mulita_usuarios_ingresar
 fun_mulita_usuarios_editar
 fun_mulita_usuarios_cambioEstado
 fun_mulita_usuarios_cambioClave
 fun_mulita_usuarios_marcas_ingresar
 fun_mulita_usuarios_login_editar
 fun_mulita_usuarios_login_cambioEstado
 fun_mulita_usuarios_login_token
 fun_mulita_usuarios_categorias_ingresar
 fun_mulita_usuarios_categorias_editar
 fun_mulita_usuarios_categorias_cambioEstado
 fun_mulita_usuarios_asociacion_categorias_ingresar
 fun_mulita_usuarios_asociacion_categorias_cambioEstado
 fun_mulita_usuarios_permisos_ingresar
 fun_mulita_usuarios_permisos_cambioEstado
 fun_mulita_grupos_usuarios_permisos_ingresar
 fun_mulita_grupos_usuarios_permisos_cambioEstado
 fun_mulita_permisos_verificar
 fun_mulita_usuarios_transaccion_ingresar
 fun_mulita_usuarios_transaccion_cambioEstado
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_modulos_cambioEstado;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_modulos_cambioEstado(
					    idModulo INT(7),
					    idEstado INT(3),     
					    idTipoEdicion INT(3), 
					    motivo TEXT, 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_gestiones_cambioEstado;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_gestiones_cambioEstado(
        				idGestion INT(7),
    					idEstado INT(3),     
    					idTipoEdicion INT(3), 
    					motivo TEXT, 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_validarDesarrollador;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_validarDesarrollador(	    
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_ingresar;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_ingresar(						   
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_guardar;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_guardar(    
						idUsuario INT(10), 
						mailUsuario VARCHAR(50), 
						imagenUsuario VARCHAR(10), 
						descripcionUsuario TEXT, 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_cambioEstado;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_cambioEstado(
						idUsuario INT(10),
						mailUsuario VARCHAR(50),
						imagenUsuario VARCHAR(10),
						descripcionUsuario TEXT,
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_cambioClave;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_cambioClave(
							idUsuario INT(10),
							clave VARCHAR(50),
							idTipoEdicion INT(3), 
							motivosUsuarios TEXT, 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_login_ingresar ;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_login_ingresar(    
							idUsuario INT(10), 
							horaLogin TIME,  
							fechaLogin DATE, 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_login_guardar;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_login_guardar(
						idLogin BIGINT(250), 
						horaLogin TIME,  
						fechaLogin DATE, 
						tipoLogin VARCHAR(100),
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_login_cambioEstado;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_login_cambioEstado(    
						idLogin BIGINT(250), 
						idEstado INT(3),
						idTipoEdicion INT(3), 
						motivos TEXT, 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_categorias_ingresar;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_categorias_ingresar(					   
					    nombre VARCHAR(30), 
					    descripcion TEXT, 
					    idEstado INT(3), 
					    idTipoEdicion INT(3), 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_categorias_guardar;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_categorias_guardar(
						    id INT(5),
						    nombre VARCHAR(30), 
						    descripcion TEXT, 
						    idTipoEdicion INT(3), 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_categorias_cambioEstado;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_categorias_cambioEstado(
						id INT(10),
						idEstado INT(3),     
						idTipoEdicion INT(3), 
						motivos TEXT, 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_asociacion_categorias_ingresar;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_asociacion_categorias_ingresar(					   
						idUsuario INT(10), 
						idCategoria INT(10), 
						idEstado INT(3), 
						idTipoEdicion INT(3), 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_asociacion_categorias_cambioEstado;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_asociacion_categorias_cambioEstado(					
						id INT(10),
						idEstado INT(3),     
						idTipoEdicion INT(3), 
						motivos TEXT, 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_permisos_ingresar;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_permisos_ingresar(   
						idUsuario INT(10),
						idModulo INT(10),
						idGestion INT(10), 
						idAccion INT(5),
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_permisos_cambioEstado;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_permisos_cambioEstado(
							id INT(10),
							idEstado INT(3),     
							idTipoEdicion INT(3), 
							motivos TEXT, 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_categorias_permisos_ingresar;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_categorias_permisos_ingresar(
						idCategoria INT(10),
						idModulo INT(10),
						idGestion INT(10), 
						idAccion INT(5),
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_categorias_permisos_cambioEstado;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_categorias_permisos_cambioEstado(
						id INT(10),
						idEstado INT(3),     
						idTipoEdicion INT(3), 
						motivos TEXT, 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_permisos_verificar;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_permisos_verificar(   
						idUsuario INT(255),
						modulo VARCHAR(100),
						gestion VARCHAR(100),
						accion VARCHAR(100)
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_transaccion_ingresar;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_transaccion_ingresar(   
						idUsuario INT(10),
						codigo VARCHAR(200),
						idModulo INT(10),
						idGestion INT(10), 
...
$sqlFunciones[] = "DROP FUNCTION IF EXISTS fun_sistema_usuarios_transaccion_cambioEstado;";
$sqlFunciones[] = "CREATE FUNCTION fun_sistema_usuarios_transaccion_cambioEstado(					   
						codigo VARCHAR(255),
...
// Ingresamos los funcionesde la gestion Modulos
foreach($sqlFunciones as $funciones){
	executarQuerry($funciones);
}
if(IFDEBUGGIN){echo("\n <br> Instalando funciones sistema");}
echo("\n <br> *** Funciones Sistema Instaladas *** <br> \n");
