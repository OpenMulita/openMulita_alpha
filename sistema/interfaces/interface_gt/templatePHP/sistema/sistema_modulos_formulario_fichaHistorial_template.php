...
<div class='row'>
	<div class='col-md-12 col-sm-12 col-xs-12'>
		<div class='x_panel'>
			<div class='x_title'>
				<h2>
					<?=$xmlFormulario->titulosM->fichaHistorial?>: <?=$objModulos->obtenerIdHistorial()?><small></small>
				</h2>
				<ul class='nav navbar-right panel_toolbox'>
					<li>
						<form name='formdatos' method='POST' action='sistema.php' class='btn-group'>
							...
							<input type='hidden' name='idFicha' value='<?=$objModulos->obtenerIDModulo()?>'>
				...
				<form id='form-ing' data-parsley-validate class='form-horizontal form-label-left'>
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<input
								...
								value='<?=$objModulos->obtenerNombreTipoEdicion()?>' 
								disabled='disabled'>
						</div>
					</div>
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<input
								class='form-control col-md-7 col-xs-12'
								value='<?=$objModulos->obtenerFechaEdicion()?>' 
								disabled='disabled'>
						</div>
					</div>
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<input
							 	class='form-control col-md-7 col-xs-12'
								value='<?=$objModulos->obtenerNombreUsuario()?>' 
								disabled='disabled'>
						</div>
					</div>
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<input
								class='form-control col-md-7 col-xs-12'
								value='<?=$objModulos->obtenerNombreModulo()?>' 
								disabled='disabled'>
						</div>
					</div>
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<textarea 
								class='form-control' 
								disabled='disabled'><?=$objModulos->obtenerDescripcion()?></textarea>
						</div>
					</div>
					...
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<input 
								class='form-control col-md-7 col-xs-12'
								value='<?=$objModulos->obtenerNombreEstado()?>'
								disabled='disabled'>
						</div>
					</div> 
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<textarea 
								class='form-control' 
								disabled='disabled'><?=$objModulos->obtenerMotivo()?></textarea>
						</div>
					</div>
