...
<div class='row'>
	<div class='col-md-12 col-sm-12 col-xs-12'>
		<div class='x_panel'>
			<div class='x_title'>
				<h2>
					<?=$xmlFormulario->titulos->fichaHistorial?> : <?=$objUsuCategoria->obtenerIdHistorial()?><small></small>
				</h2>
				<ul class='nav navbar-right panel_toolbox'>
					<li>
						<form name='formdatos' method='POST' action='sistema.php' class='btn-group'>
							...
							<input type='hidden' name='idFicha' value='<?=$objUsuCategoria->obtenerID()?>'>
				...
				<form id='form-ing' data-parsley-validate class='form-horizontal form-label-left'>
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<input
								...
								value='<?=$objUsuCategoria->obtenerNombreTipoEdicion()?>' 
								disabled='disabled'>
						</div>
					</div>
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<input
								class='form-control col-md-7 col-xs-12'
								value='<?=$objUsuCategoria->obtenerFechaEdicion()?>' 
								disabled='disabled'>
						</div>
					</div>
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<input
								class='form-control col-md-7 col-xs-12'
								value='<?=$objUsuCategoria->obtenerNombreUsuario()?>' 
								disabled='disabled'>
						</div>
					</div>
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<input 
								class='form-control col-md-7 col-xs-12'
								value='<?=$objUsuCategoria->obtenerNombre()?>' 
								disabled='disabled'>
						</div>
					</div>
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<textarea 
								class='form-control' 
								disabled='disabled'><?=$objUsuCategoria->obtenerDescripcion()?></textarea>
						</div>
					</div>
					...
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<input 
								class='form-control col-md-7 col-xs-12'
								value='<?=$objUsuCategoria->obtenerNombreEstado()?>'
								disabled='disabled'>
						</div>
					</div> 
					<div class='form-group'>
						...
						<div class='col-md-6 col-sm-6 col-xs-12'>
							<textarea 
								class='form-control' 
								disabled='disabled'><?=$objUsuCategoria->obtenerMotivo()?></textarea>
						</div>
					</div>
