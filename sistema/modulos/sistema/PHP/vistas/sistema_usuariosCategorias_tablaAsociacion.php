<?php 
	...
	$xmlTabla = $objUsuarioCategoria->tablasIdioma($MODULO,$GESTION,"usuariosCategoriasListarAsociacion",$IDIOMA);
	
	$objUsuarioCategoria->cargarUsuarioSistema($SISUSER);
	$listarTabla = $objUsuarioCategoria->listas("tablaAsociacionUsuarios", $IDFICHA, 0);
