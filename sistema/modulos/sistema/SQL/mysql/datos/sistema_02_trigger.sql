...
DROP TRIGGER IF EXISTS trg_sistema_modulos_ingresar;
DROP TRIGGER IF EXISTS trg_sistema_modulos_actualizar;
DROP TRIGGER IF EXISTS trg_sistema_gestiones_ingresar;
DROP TRIGGER IF EXISTS trg_sistema_gestiones_actualizar;

DROP TRIGGER IF EXISTS trg_sistema_usuarios_ingresar;
DROP TRIGGER IF EXISTS trg_sistema_usuarios_actualizar;

DROP TRIGGER IF EXISTS trg_sistema_usuarios_categoria_ingresar;
DROP TRIGGER IF EXISTS trg_sistema_usuarios_categoria_actualizar;
DROP TRIGGER IF EXISTS trg_sistema_usuarios_asociacion_categoria_ingresar;
DROP TRIGGER IF EXISTS trg_sistema_usuarios_asociacion_categoria_actualizar;

DROP TRIGGER IF EXISTS trg_sistema_usuarios_permisos_ingresar;
DROP TRIGGER IF EXISTS trg_sistema_usuarios_permisos_actualizar;
DROP TRIGGER IF EXISTS trg_sistema_usuarios_categorias_permisos_ingresar;
DROP TRIGGER IF EXISTS trg_sistema_usuarios_categorias_permisos_actualizar;
...
DELIMITER $$
CREATE TRIGGER trg_sistema_modulos_ingresar 
...
DELIMITER $$
CREATE TRIGGER trg_sistema_modulos_actualizar 
...
DELIMITER $$
CREATE TRIGGER trg_sistema_gestiones_ingresar AFTER INSERT ON sistema_gestiones
FOR EACH ROW BEGIN
	DECLARE maxId INT;
...
DELIMITER $$
CREATE TRIGGER trg_sistema_gestiones_actualizar AFTER UPDATE ON sistema_gestiones
FOR EACH ROW BEGIN
		INSERT INTO sistema_gestiones_historial SET
		sgh_idTipoEdicion = NEW.sg_idTipoEdicion, 
...
DELIMITER $$
CREATE TRIGGER trg_sistema_usuarios_categoria_ingresar AFTER INSERT ON sistema_usuarios_categorias
FOR EACH ROW BEGIN
	DECLARE maxId INT;
...
DELIMITER $$
CREATE TRIGGER trg_sistema_usuarios_categoria_actualizar AFTER UPDATE ON sistema_usuarios_categorias
FOR EACH ROW BEGIN
	INSERT INTO sistema_usuarios_categorias_historial SET
		such_idTipoEdicion = NEW.suc_idTipoEdicion, 
...
-- ****************** Usuarios Asociacion Categorias *************************
...
DELIMITER $$
CREATE TRIGGER trg_sistema_usuarios_permisos_ingresar AFTER INSERT ON sistema_usuarios_permisos
FOR EACH ROW BEGIN
	DECLARE maxId INT;
...
DELIMITER $$
CREATE TRIGGER trg_sistema_usuarios_permisos_actualizar AFTER UPDATE ON sistema_usuarios_permisos
FOR EACH ROW BEGIN
	INSERT INTO sistema_usuarios_permisos_historial SET
		suph_idTipoEdicion = NEW.sup_idTipoEdicion, 
...
DELIMITER $$
CREATE TRIGGER trg_sistema_usuarios_categorias_permisos_ingresar AFTER INSERT ON sistema_usuarios_categorias_permisos
FOR EACH ROW BEGIN
	DECLARE maxId INT;
